...
@interface GSXBoloController : NSObject <NSApplicationDelegate, NSWindowDelegate, NSToolbarDelegate, NSTableViewDelegate, NSTableViewDataSource, NSMenuDelegate, NSTabViewDelegate> {
